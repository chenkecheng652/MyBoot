...
<table border="0" width="1140px" cellspacing="0" cellpadding="0"
	...
	<tr>
   <td class="login_msg" width="200" align="center">
	 ...
	 <fieldset style="width: 300px; margin: 0px auto;">
		...
		<form action="${pageContext.request.contextPath }/login.action"
          ...
          <br /><br />
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<center><input type="button" id= "register" value="注册" onclick="javascript:window.location.href='/MyBoot_war_exploded/toRegister.jsp'">
          <input type="submit" value="登录" /></center>
		 </form>
	 </fieldset>
	</td>
	</tr>
